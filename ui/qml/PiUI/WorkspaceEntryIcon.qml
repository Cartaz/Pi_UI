...
Item {
    ...
    Item {
        ...
        Rectangle { x: 5; y: 5; width: 6; height: 1; radius: 0.5; color: icon.strokeColor; opacity: 0.72 }
        Rectangle { x: 5; y: 8; width: 6; height: 1; radius: 0.5; color: icon.strokeColor; opacity: 0.72 }
        Rectangle { x: 5; y: 11; width: 4; height: 1; radius: 0.5; color: icon.strokeColor; opacity: 0.72 }
    }
