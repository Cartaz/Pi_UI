...
QtObject {
    readonly property color surface: Qt.rgb(20 / 255, 20 / 255, 20 / 255)
    readonly property color accent: Qt.rgb(1, 102 / 255, 0)
    readonly property color textPrimary: Qt.rgb(225 / 255, 225 / 255, 225 / 255)
    readonly property color textSecondary: Qt.rgb(135 / 255, 135 / 255, 135 / 255)
    readonly property color textMuted: Qt.rgb(90 / 255, 90 / 255, 90 / 255)
    ...
    readonly property color errorText: Qt.rgb(220 / 255, 132 / 255, 96 / 255)
